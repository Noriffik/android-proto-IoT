...
public class ActivityTutorial extends AppCompatActivity {
    ...
    @BindView(R.id.btn_finish) TextView btnFinish;
    ...
    @SuppressWarnings("unused") @OnClick(R.id.btn_finish)
    ...
    private void init() {
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            @Override public void onPageSelected(int position) {
                ...
                btnNext.setVisibility(position + 1 == mDotsCount ? View.GONE : View.VISIBLE);
                btnFinish.setText(position + 1 == mDotsCount ? R.string.t_lets_start : R.string.t_skip);
            }
